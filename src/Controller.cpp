...
Controller::Controller(FileManager* fileManager, int port, std::vector<int>& ports) : fileManager(fileManager), port(port) {
...
void Controller::writeConsole(std::ostream& outputStream, const std::string& message) {
...
void Controller::createStubConnection(int stub_id, int port) {
